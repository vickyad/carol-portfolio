...
export const projects = [
  {
    ...
    typography: ["Barlow", "Trade Gothic LT"],
    ...
    colorPalette: [
      { name: "primary", color: "#0F206C" },
      { name: "secondary", color: "#3A8DDE" },
      { name: "white", color: "#FFFFFF" },
      { name: "light gray", color: "#F2F6FF" },
      { name: "dark gray", color: "#3E3E3E" },
    ],
    colorPaletteDescription: [
      "Our approach involved incorporating plenty of white for open spaces and introducing touches of both primary and secondary blues strategically across the site.",
      "This was done to highlight crucial information and achieve a minimalistic yet refined appearance.",
    ],
  ...
  },
  {
    ...
    styleGuideDescription:
      "Aligned with the brand's visual identity, we created a comprehensive style guide for developers. Here’s a small preview of our work.",
    typography: ["SF Pro Display", "Noto Sans"],
    typographyDescription: [
    ...
    colorPalette: [
      { color: "#800F0F", name: "primary" },
      { color: "#2E2E2E", name: "secondary" },
      { color: "#FFFFFF", name: "white" },
      { color: "#FACE7F", name: "yellow" },
      { color: "#FAA773", name: "orange" },
      { color: "#DF605A", name: "coral" },
    ],
    colorPaletteDescription: [
      "To enhance the vibrancy of the brand's red hues, we've introduced yellow, as indicated by Usertesting.com, signifying happiness, and orange, representing confidence and success.",
      "These are the sentiments Souza Advogados aims to evoke in its clients.",
    ],
  ...
  },
  {
    ...
    styleGuideDescription:
      "Aligned with the brand's visual identity, we created a comprehensive style guide for developers. Here’s a small preview of our work.",
    typography: ["Trade Gothic LH", "Trade Gothic Lt Std", "Monarcha"],
    typographyDescription: [
    ...
    colorPalette: [
      { color: "#00573F", name: "primary" },
      { color: "#D8ED99", name: "secondary" },
      { color: "#FFFFFF", name: "white" },
      { color: "#9BD3DD", name: "blue" },
      { color: "#A85D2C", name: "orange" },
      { color: "#000000", name: "black" },
    ],
    colorPaletteDescription: [
      "Our approach to the color palette incorporates a heavier use of light colors to create significant empty space and breathing room. This will be complemented by our primary dark green as the base, resulting in a crafted and fresh look and feel.",
      "Additionally, we incorporate our secondary colors to inject vitality and energy into the design.",
    ],
